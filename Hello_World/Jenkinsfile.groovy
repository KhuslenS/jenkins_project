node {
  ...
  stage("Pull Repo"){
    sh "ssh ec2-user@${khuslen} git clone https://github.com/Khuslentuguldur/flask-examples.git"
  }
  ...
  stage("Pip install"){
    sh "ssh ec2-user@${khuslen} sudo pip install -r /home/ec2-user/flask-examples/requirements.txt"
  }
  stage("Run App"){
    sh "ssh ec2-user@${khuslen} sudo python /home/ec2-user/flask-examples/01-hello-world/hello.py"
  }
}
